...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      { path: "", redirect: "requetes" },
      { path: "requetes", detail: { label: "Requêtes", iconClass: "oj-ux-ico-file-text" } },
    ...
    this.appName = ko.observable("Mini App MongoDB");
    // user Info used in Global Navigation area

    this.userLogin = ko.observable("aurink.grellet@gmail.com");
    // footer
    this.footerLinks = [
